...
public class FireCrystalItem extends Item implements ICrystalItem {

    public FireCrystalItem(Properties props) { super(props); }

    @Override public int tint() { return 0xF59875; }
    @Override public AtmosphericForcing.Bias bias() { return AtmosphericForcing.Bias.HEATING; }
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext context,
        ...
        AWTooltips.append(tooltip, "item.advancedweather.fire_crystal.tip", 3);
    }
}
