...
public class AshOverlay {

    private static final ResourceLocation PIPELINE_ID =
            ResourceLocation.fromNamespaceAndPath("advancedweather", "ash_overlay");
    ...
    public static void onClientTick(ClientTickEvent.Post event) {
        ...
        boolean shouldRender = ClientWeatherState.hasEffect(WeatherEffects.ASH_PARTICLES)
