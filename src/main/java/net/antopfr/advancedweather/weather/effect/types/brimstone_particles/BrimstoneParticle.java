...
public class BrimstoneParticle extends TextureSheetParticle {
    ...
    protected BrimstoneParticle(ClientLevel level, double x, double y, double z,
        ...
        this.quadSize = (float) (config.brimstoneSizeMin +
                random.nextFloat() * config.brimstoneSizeMax - config.brimstoneSizeMin);
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level,
            ...
            return new BrimstoneParticle(level, x, y, z, xSpeed, zSpeed, sprites);
        }
    }
}