...
public class SandParticle extends TextureSheetParticle {
    protected SandParticle(ClientLevel level, double x, double y, double z,
        ...
        this.quadSize = (float) (config.sandSizeMin +
                        random.nextFloat() * (config.sandSizeMax - config.sandSizeMin));
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level,
            ...
            return new SandParticle(level, x, y, z, xSpeed, zSpeed, sprites);
        }
    }
}
